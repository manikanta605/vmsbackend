...
// console.log("INSERT INTO `tbl_violations_amend_requests`(`violation_id`, `amend_message`, `user_id`, `status`, `created_on`,`images`) VALUES ('" + data.violation_id + "','" + data.amend_message + "','" + data.user_id + "','Not Approved','" + data.created_on + "','" + data.file + "')");
